        ...
        private DomainEventStream GetFromAttribute(DomainEventStreamAttribute attribute)
        {
            ...
            if (domainEventStreamStorage == null)
            {
                throw new ArgumentException(
                    "Unexpected type of Connection String. Can not instantiate a DomainEventStream Storage. Please fix the Connection String or use only a Sql Server or CosmosDB Connection String.");
            }
